...
class ExportStream(CallMinerStream):
    ...
    def get_records(self, context):
        yield {
            "tmp_dir": "/tmp/tap-callminer",
            "job_execution_id": "e68e366d-692a-4b04-a1d6-01977b6c2200",
        }
            ...
            for count in itertools.count(1):
                ...
                if not job_execution:
                    ...
                    if job_execution_status == "Completed":
                        ...
                        break
                    elif job_execution_status == "Failed":
                        msg = (
                            f"Job execution {job_execution_id} failed at "
                            f"{job_execution_completed_at}"
                        )
                        raise RuntimeError(msg)
